...
if __name__ == '__main__':
    ...
    # for i in [1, 2]:
    #     if not os.path.exists('dataset_LAX/{0}'.format(i)):
    #         os.makedirs('dataset_LAX/{0}'.format(i))
    #     for seq_name in ['sa', 'la_2ch', 'la_4ch', 'ao']:
    #         f = 'dataset_LAX/{0}/{1}.nii.gz'.format(i, seq_name)
    ...
    os.system('CUDA_VISIBLE_DEVICES={0} python3 common/deploy_network.py --seq_name sa --data_dir dataset_LAX '
    ...
    os.system('python3 short_axis/eval_ventricular_volume.py --data_dir dataset_LAX '
              '--output_csv demo_csv/table_ventricular_volume.csv')

    # Evaluate wall thickness
    print('Evaluating myocardial wall thickness ...')
    os.system('python3 short_axis/eval_wall_thickness.py --data_dir dataset_LAX '
    ...
    if shutil.which('mirtk'):
        ...
        os.system('python3 short_axis/eval_strain_sax.py --data_dir dataset_LAX '
    ...
    # Deploy the segmentation network
    print('Deploying the segmentation network ...')
    os.system('CUDA_VISIBLE_DEVICES={0} python3 common/deploy_network.py --seq_name la_2ch --data_dir dataset_LAX '
              '--model_path trained_model/FCN_la_2ch'.format(CUDA_VISIBLE_DEVICES))

    os.system('CUDA_VISIBLE_DEVICES={0} python3 common/deploy_network.py --seq_name la_4ch --data_dir dataset_LAX '
    ...
    os.system('python3 long_axis/eval_atrial_volume.py --data_dir dataset_LAX '
              '--output_csv demo_csv/table_atrial_volume.csv')

    # Evaluate strain values
    if shutil.which('mirtk'):
        print('Evaluating strain from long-axis images ...')
        os.system('python3 long_axis/eval_strain_lax.py --data_dir dataset_LAX '
